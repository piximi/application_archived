...
export const UPDATE_CONTRAST_FOR_ALL_IMAGES = 'UPDATE_CONTRAST_FOR_ALL_IMAGES';
...
export const UPDATE_UNSELECTED_CHANNELS = 'UPDATE_UNSELECTED_CHANNELS';

export const UPDATE_UNSELECTED_CHANNELS_FOR_ALL_IMAGES =
